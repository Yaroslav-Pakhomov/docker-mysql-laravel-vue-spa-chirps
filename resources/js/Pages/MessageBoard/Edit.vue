...
<template>
    <Head>
        <title>Laravel SPA - Редактирование</title>
    ...
    <div class="min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 py-12 px-60">
        ...
        <div class="w-auto mx-auto text-center">
            <br>
            <br>
            Доска объявлений - Редактирование объявления
            <br>
            <br>
            <form @submit.prevent="updateSubmit">
                ...
                <div class="col-span-full">
                    ...
                    <p class="mt-3 mb-1 text-sm text-justify leading-6 text-gray-600">Напишите несколько
                        предложений.</p>
                </div>
